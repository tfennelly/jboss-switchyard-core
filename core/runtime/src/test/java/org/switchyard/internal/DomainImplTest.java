...
public class DomainImplTest {
    ...
    public void testCreateExchange() {
        Exchange inOnly = _domain.createExchange(_service, ExchangeContract.IN_ONLY_DEFAULT);
        Assert.assertEquals(ExchangePattern.IN_ONLY, inOnly.getContract().getServiceOperation().getExchangePattern());
        Exchange inOut = _domain.createExchange(_service, ExchangeContract.IN_OUT_DEFAULT);
